...
const CartScreen = () => {
  ...
  const shipping = cartTotal < 45 ? 5.99 : 0; // flat shipping rate for simplicity
  const tax = subtotal * 0.07; // assuming a 7% sales tax
  ...
  const handleCheckout = () => {
    ...
    // check if user has at least one address before allowing checkout
    ...
    // show address selection modal before proceeding to payment
  ...
  const handleProceedWithPayment = async (selectedAddress: Address) => {
    ...
    try {
      ...
      // initialize the payment sheet with the client secret from the payment intent (in the backend)
      ...
      if (initError) {
        Sentry.logger.error("Payment sheet initialization failed", {
                  ...
                  <View className="flex-row items-center mt-3">
                    ...
                    >
                      {isUpdating ? (
                        ...
                        <Ionicons name="remove" size={18} color="#F5F0E8" />
                      )}
                    </TouchableOpacity>
                    ...
                    >
                      {isUpdating ? (
                        ...
                        <Ionicons name="add" size={18} color="#F5F0E8" />
                      )}
                    </TouchableOpacity>
