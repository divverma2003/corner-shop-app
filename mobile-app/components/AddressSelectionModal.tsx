...
// Props for the AddressSelectionModal component
    ...
    >
      <View className="flex-1 bg-black/50 justify-end">
        <View className="bg-background rounded-t-3xl h-1/2">
          ...
          {/* Addresses List */}
          <ScrollView className="flex-1 p-6" indicatorStyle="white">
            {addressesLoading ? (
              <View className="py-8">
                <ActivityIndicator size="large" color="#F5F0E8" />
              </View>
            ) : (
              ...
              <View className="flex-row items-center justify-center">
                {isProcessing ? (
                  ...
                  <>
                    ...
                    <Ionicons name="arrow-forward" size={20} color="#FFFFF" />
                  </>
                )}
              </View>
            </TouchableOpacity>
